    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="flex items-center justify-between max-w-7xl mx-auto px-6 py-5 border-b border-border/40">
        <Link to="/" className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold">Sculptor AI</span>
        </Link>
        <Link to="/signup">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-12">
        <div>
          ...
          <p className="text-lg text-muted-foreground mt-3">
            Complete guide to Sculptor AI — your agentic database design assistant, from analysis to continuous refinement
          </p>
        </div>
        ...
        <section id="overview" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Sculptor AI is a specialized, database-focused agentic developer support system backed by 
        ...
        <section id="research-foundation" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Sculptor AI is built on over a decade of peer-reviewed research published at top-tier 
        ...
        <section id="object-model-input-formats" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Sculptor AI accepts object models in three formats. Each is parsed into a canonical representation 
...
association CustomerOrder: Customer -> Order (ONE to MANY)`}</pre>
        ...
        <section id="pareto-front-identification" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            After the RL agents explore the design space, Sculptor AI identifies the Pareto front using 
        ...
        <section id="formal-verification" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Sculptor AI verifies generated schemas using formal verification to ensure structural and 
        ...
        <section id="ide-integration" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            The Sculptor AI VS Code / Cursor extension brings the full agentic pipeline directly into your 
        ...
        <section id="agentic-lifecycle" className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Sculptor AI is not just a one-shot tool — it's a continuous design partner. The agentic lifecycle includes:
          </p>
          <div className="space-y-3">
            <div className="p-4 rounded-lg border border-border/60">
